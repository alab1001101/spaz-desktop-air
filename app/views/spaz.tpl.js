...
Spaz.Templates.timeline_entry = function(d) {
	...
	if (d.SC_is_retweet) {
		...
		//d.id = d.retweeted_status.id; This breaks remembering markAsRead
...
Spaz.Templates.timeline_entry_dm = function(d) {
	...
	entryHTML += 'dm" data-status-id="'+d.id+'" data-user-screen_name="'+d.sender_screen_name+'" data-user-id="'+d.sender.id+'" data-timestamp="'+d.SC_created_at_unixtime+'">';
